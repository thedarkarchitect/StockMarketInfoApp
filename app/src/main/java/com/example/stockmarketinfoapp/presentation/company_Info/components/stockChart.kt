...
//        Paint().apply {
//            color = Color.White
//            density.run { 12.sp.toPx() }
//        }
        Paint().apply {//this uses the android.graphics package for the Paint() class
    ...
    Canvas(modifier = modifier) {
        ...
        (0 until infos.size - 1 step 2).forEach { i ->
            ...
            drawContext.canvas.nativeCanvas.apply {
                drawText(//this function is from the android.graphics.Canvas
                    hour.toString(),
        ...
        val filPath = Path(strokePath.asAndroidPath())
            .asComposePath()
            .apply {
